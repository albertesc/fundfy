import { c as createComponent, a as createAstro, m as maybeRenderHead, b as addAttribute, f as renderTemplate, u as unescapeHTML, d as renderComponent, j as renderScript, e as renderSlot, r as renderHead } from './astro/server_Eu3TDnBi.mjs';
import { g as getI18N, b as $$Button, $ as $$Header, a as $$Footer, c as createSvgComponent, M as MENU_SCROLL_POSITIONS } from './Footer_DL3O5-PZ.mjs';
import { a as actions } from './_astro_actions_BqoHBHfj.mjs';
/* empty css                         */
/* empty css                         */
...
const $$Lines = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="fixed w-full h-full top-0 left-0 right-0 bottom-0 -z-50"> <div class="max-w-[1130px] mx-auto w-full h-full px-4 relative"> <span class="block w-[0.5px] h-full absolute top-0 left-0 bg-black"></span> <span class="block w-[0.5px] h-full absolute top-0 left-1/4 bg-black"></span> <span class="block w-[0.5px] h-full absolute top-0 left-2/4 bg-black"></span> <span class="block w-[0.5px] h-full absolute top-0 left-3/4 bg-black"></span> <span class="block w-[0.5px] h-full absolute top-0 left-none right-0 bg-black"></span> </div> </div>`;
}, "/Users/albert/Sites/fundfy/src/components/atoms/Lines.astro", void 0);

const $$Astro$2 = createAstro();
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$2, $$props, $$slots);
  Astro2.self = $$Layout;
  return renderTemplate`<html lang="en"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width"><!-- Favicon --><link rel="icon" type="image/png" href="/favicon.ico"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>Fundfy</title>${renderHead()}</head> <body class="bg-[#242827] text-white overflow-x-hidden"> ${renderComponent($$result, "Header", $$Header, {})} <main> ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "Footer", $$Footer, {})} </main> ${renderComponent($$result, "Lines", $$Lines, {})} </body></html>`;
...
export { $$Layout as $, $$Hero as a, $$HeroCard as b, $$HeroBackground as c, $$Faqs as d, $$Contact as e };
